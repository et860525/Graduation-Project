...
def search_result(request, stockname):
    ...
    if request.method == "GET":
        ...
        try:
            ...
            earnings_date = earnings.index.tolist()
            ...
            financials.drop(['Effect Of Accounting Charges', 'Minority Interest',
                             'Other Operating Expenses', 'Extraordinary Items', 
                             'Non Recurring', 'Other Items', 'Discontinued Operations'], 
                             inplace=True)
            ...
            context = {'stockname': stockname[0], 'infos': infos,
                       ...
                       'stock_price_all': stock_price_all, 'stock_list_Symbol': stock_list['Symbol'] + ', ' + stock_list['Name'],
                       'major_holders': major_holders, 'institutional_holders': institutional_holders,
                       'earnings': earnings, 'earnings_date': earnings_date, 'financials': financials}
